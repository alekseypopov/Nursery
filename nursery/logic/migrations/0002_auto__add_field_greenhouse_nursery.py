...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Greenhouse.nursery'
        db.add_column('logic_greenhouse', 'nursery', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['logic.Nursery']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Greenhouse.nursery'
        db.delete_column('logic_greenhouse', 'nursery_id')
